...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div title="IC Shipped Pallet" style="text-align: left">
		...
		<tr>
			<td style="text-align: center; width: 238px;">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="DarkRed" 
								Style="vertical-align: middle; text-align: center" Text="OW Inventory - Void Shipped Pallet" EnableViewState="False" ></asp:Label></td>
		</tr>
		<tr>
			<td style="text-align: center; width: 238px;">
