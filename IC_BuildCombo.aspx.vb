...
#End Region
    ...
    '    End Try
    'End Function
    '    Public Function CreateCDPrintJob(ByVal _printer As Integer, _
    '                                        ByVal _formatName As String, ByVal _labelQty As Integer, _
    '                                        ByVal _combono As Integer, ByVal _racks As String, _
    '                                        ByVal _combodatetime As Date, ByVal _ingredients As String, _
    '                                        ByVal _formula As String, ByVal _stuffgroup As String, _
    '                                        ByVal _lotno As Integer, ByVal _netwt As Integer, _
    '                                        ByVal _comboAssociate As Integer, ByVal _grosswt As Integer, ByVal _formuladescription As String) As Boolean

    'Dim _printingEnabled As Boolean

    '    If (ConfigurationManager.AppSettings("PrintingEnabled") = "True") Then
    '        _printingEnabled = True
    '    Else
    '        _printingEnabled = False
    '    End If
    '    CreateCDPrintJob = False

    '    Try
    '        If _printingEnabled Then
    ''Drop file into Loftware program for printing of pallet labels
    'Dim strLine1 As String = "*FORMAT," & _formatName.ToString
    'Dim strLine2 As String = "BC_Combo," & _combono.ToString
    'Dim strLine3 As String = "HR_RacksInCombo," & _racks.ToString
    'Dim strLine4 As String = "HR_Formula," & _formuladescription.ToString
    'Dim strLine5 As String = "HR_StuffingGroup," & _stuffgroup.ToUpper
    'Dim strLine6 As String = "HR_ComboDate," & _combodatetime.ToString
    'Dim strLine7 As String = "HR_Lot," & _lotno.ToString
    'Dim strLine8 As String = "HR_NetWt," & _netwt.ToString
    'Dim strLine9 As String = "HR_GrossWt," & _grosswt.ToString
    'Dim strLine10 As String = "HR_Associate," & _comboAssociate.ToString
    'Dim strLine11 As String = "HR_Ingredients," & _ingredients.ToString
    'Dim strLine12 As String = "*QUANTITY," & _labelQty.ToString
    'Dim strLine13 As String = "*PRINTERNUMBER," & _printer.ToString
    'Dim strLine14 As String = "*PRINTLABEL"

    'Dim destPath As String = "\\SRV04\wddrop\"
    'Dim tempPath As String = "\\SRV04\wddroptemp\"

    'Dim filenm As String = Trim(_combono) & DatePart("yyyy", Now) & DatePart("m", Now) & DatePart("d", Now) & DatePart("h", Now) & DatePart("n", Now) & DatePart("s", Now) & ".pas"
    'Dim PathFile As String = tempPath & filenm
    ...
    'Dim sourceFile As String = tempPath & filenm
    'Dim successfile As String = tempPath & filenm & ".success"
    'Dim destinationFile As String = destPath & filenm
    ...
    '        End If
    '        CreateCDPrintJob = True
    '    Catch ex As Exception
    ''Throw ex
    '        Throw New Exception("Call to CreateJob ComboTagPrint exited with error - " & ex.Message)
    '        Exit Function
    '    End Try
    'End Function
