<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IC_LoadPalletOnPacklandTruck.aspx.vb" Inherits="OWS_IC.IC_LoadPalletOnPacklandTruck" %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <div title="Load Pallet On Packland Truck" style="text-align: left">
		...
		<tr>
			<td style="text-align: center">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="DarkRed" 
								Style="vertical-align: middle; text-align: center" Text="OW Inventory - Load Pallet On Packland Truck" EnableViewState="False" ></asp:Label></td>
		</tr>
		<tr>
			<td style="text-align: center">
	...
	<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td style="width: 95px; vertical-align: bottom; text-align: right; height: 30px;">
			...
			<td style="width: 145px; vertical-align: bottom; height: 30px">
		...
		<tr>
			<td style="width: 239px; text-align: center">
			    <asp:Label ID="lbResult" runat="server"
					...
					Style="vertical-align: middle; text-align: right" BorderStyle="Solid" BorderWidth="1px" Visible="False"></asp:Label></td>
		</tr>
	</table>
