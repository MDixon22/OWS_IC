    ...
    <table class="table table-striped" style=" border="0" cellpadding="0" cellspacing="0">
		...
		<tr class="row flex-fill">
			<td style="text-align: center">
				<asp:Label ID="lbPrompt" runat="server" Font-Bold="True" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="Scan Case Label" ></asp:Label></td>
		</tr>
		<tr class="row flex-fill">
			<td class="col-1" style="text-align: center">
	...
	<table class="table table-striped" style=" border="0" cellpadding="0" cellspacing="0">
		<tr class="row flex-fill">
			<td class="col-1" style="text-align: center;">
                ...
                <asp:Button ID="btMixed" runat="server" Font-Bold="False" Text="MIXED" /></td>
		</tr>
	</table>
	<table class="table table-striped" style=" border="0" cellpadding="0" cellspacing="0">
        <tr class="row flex-fill">
            ...
            <td class="col-2" style="text-align: left;"><asp:Label ID="lbTest" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="2. Test Product" Visible="False"></asp:Label></td>
        </tr>
        <tr class="row flex-fill">
            <td class="col-2" style="text-align: left;">
                <asp:Label ID="lbDefective" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="3. Defective Product" Visible="False"></asp:Label></td>
            <td class="row flex-fill" style="text-align: left;">
                <asp:Label ID="lbEndOfRunPartial" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="4. End Of Run/Partial Case" Visible="False"></asp:Label></td>
        </tr>
        <tr class="row flex-fill">
            <td class="col-2" style="text-align: left;">
                <asp:Label ID="lbCheese" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="5. Cheese" Visible="False"></asp:Label></td>
            <td class="col-2" style="text-align: left;">
                <asp:Label ID="lbEndsCurls" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="6. Ends and Curls" Visible="False"></asp:Label></td>
        </tr>
        <tr class="row flex-fill">
            <td class="col-2" style="text-align: left;">
                <asp:Label ID="lbGreaseOut" runat="server" Font-Bold="False" ForeColor="Firebrick" Style="vertical-align: middle; text-align: center" Text="7. Grease Out" Visible="False"></asp:Label></td>
            <td class="col-2" style="text-align: left;"></td>
        </tr>
    </table>
	<table class="table table-striped" style=" border="0" cellpadding="0" cellspacing="0">
		<tr class="row flex-fill">
