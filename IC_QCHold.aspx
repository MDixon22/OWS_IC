			    ...
			    <tr class="row flex-fill justify-content-center">
				    <td style="text-align: center">
						<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="3em" ForeColor="DarkRed" EnableViewState="False"
							Style="vertical-align: middle; text-align: center" Text="OW Inventory - Pallet to QC Hold Status"></asp:Label>
				    </td>
			    </tr>
			    <tr class="row flex-fill justify-content-center">
				    <td style="text-align: center">
			    ...
			    <tr class="row flex-fill justify-content-center">
				    <td class="col-6 d-flex flex-column text-center" style="border-style: hidden">
					    <asp:Label ID="lbConfirm" runat="server" Font-Bold="True" Font-Size="3em" ForeColor="DarkRed" 
                            Style="vertical-align: middle; text-align: right" Text="Confirm QC Hold-" Visible="False"></asp:Label>
				    </td>
                    ...
                    <td class="col-4 d-flex flex-column text-center" style="border-style: hidden">
					    <asp:Label ID="lbYN" runat="server" EnableViewState="False" Font-Bold="True" Font-Size="3em"
						    ForeColor="Red" Style="vertical-align: middle; text-align: left" Text="Y or N"></asp:Label>
                    </td>
			    </tr>
		        <tr class="row flex-fill justify-content-center">
