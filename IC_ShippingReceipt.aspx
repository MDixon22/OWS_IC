        ...
        <div title="IC Bin Transfer" class="container-fluid">
		        ...
		        <tr class="row flex-fill justify-content-center">
			        <td style="text-align: center">
					    <asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="3em" ForeColor="DarkRed" EnableViewState="False" 
							Style="vertical-align: middle; text-align: center" Text="OW Inventory - Recv Pallet in Shipping" ></asp:Label>
			        </td>
		        </tr>
		        <tr class="row flex-fill justify-content-center">
			        <td style="text-align: center">
	        ...
	        <table class="table">
		        ...
		        <tr class="row flex-fill justify-content-center">
			        ...
			        <td class="col-7 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:TextBox ID="txCaseLabel" runat="server" Font-Size="3em" ForeColor="Black" 
                            BorderColor="Black" BorderWidth="1px" Visible="False" AutoPostBack="True" Columns="10"></asp:TextBox>
			        </td>
		        </tr>
		        <tr class="row flex-fill justify-content-center">
			        <td class="col-3 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:Label ID="lbQty" runat="server" Font-Bold="False" Font-Size="3em" ForeColor="DarkRed" 
                            Style="vertical-align: middle; text-align: right" Text="Quantity" Visible="False"></asp:Label>
			        </td>
			        <td class="col-7 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:TextBox ID="txQty" runat="server" Font-Size="3em" ForeColor="Black" 
                            BorderColor="Black" BorderWidth="1px" Visible="False" AutoPostBack="True" Columns="10"></asp:TextBox>
			        </td>
		        </tr>
		        <tr class="row flex-fill justify-content-center">
			        <td class="col-5 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:Label ID="lbYN" runat="server" Font-Bold="False" Font-Size="3em" ForeColor="DarkRed" 
                            Style="vertical-align: middle; text-align: right" Text="Accept Quantity?" Visible="False"></asp:Label>
			        </td>
			        <td class="col-2 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:TextBox ID="txYN" runat="server" Font-Size="3em" ForeColor="Black" 
                            BorderColor="Black" BorderWidth="1px" Visible="False" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td class="col-3 d-flex flex-column text-center" style="border-style: hidden">
                        <asp:Label ID="lbYorN" runat="server" Font-Bold="False" Font-Size="3em" ForeColor="DarkRed" 
                            Style="vertical-align: middle; text-align: center" Text="Y or N" Visible="False"></asp:Label>
			        </td>
                </tr>
		        <tr class="row flex-fill justify-content-center">
			        <td class="col-10 d-flex flex-column text-center" style="border-style: hidden">
				        <asp:Label ID="lbError" runat="server" BorderColor="DarkRed" BorderStyle="Solid" BorderWidth="1px" 
                            Font-Bold="False" Font-Size="3em" ForeColor="Red" Style="vertical-align: middle; text-align: center" Visible="False">
			            </asp:Label>
			        </td>
		        </tr>
		        <tr class="row flex-fill justify-content-center">
			        ...
			        <td class="col-5 d-flex flex-column text-start" style="border-style: hidden">
                        <asp:Button ID="btNextPallet" runat="server" Font-Size="3em" Text="Next Pallet" Font-Bold="True" Visible="False" style="margin-bottom:1em"/>
