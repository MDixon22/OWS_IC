...
Partial Public Class IC_SamplePalletEditNew
    ...
    Public Function AddProdToSamplePallet(ByVal pallet As Long, ByVal gtin As String, ByVal codedate As String, ByVal palletqty As Integer, _
        ...
        If Not DB.MakeSQLConnection("Warehouse") Then
            ...
            If Not sqlCmdPalletUpdate Is Nothing Then
                sqlCmdPalletUpdate.Parameters.AddWithValue("@pdtmScanned", dtmScanned)
                sqlCmdPalletUpdate.Parameters.AddWithValue("@pstrUnit", strUnit)
                sqlCmdPalletUpdate.Parameters.AddWithValue("@pstrProduct", gtin)
                sqlCmdPalletUpdate.Parameters.AddWithValue("@pstrExpiration", codedate)
