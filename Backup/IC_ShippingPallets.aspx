<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IC_ShippingPallets.aspx.vb" Inherits="OWS_IC.IC_ShippingPallets" %>
	...
	<div style="text-align: left" title="IC Shipping Pallets" align="left">
			...
			<tr>
				<td style="text-align: center; height: 19px;">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="X-Small"
						...
						Text="OW Inventory - AddTo Shipping Pallet" EnableViewState="False" EnableTheming="False"></asp:Label></td>
			</tr>
			<tr>
				<td style="text-align: center; height: 19px;">
		...
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td style="width: 119px; text-align: center">
					<asp:Button ID="btNo" runat="server" Font-Bold="True" Font-Size="Large" Text="- No -" Visible="False" Height="30px" /></td>
				<td style="width: 119px; text-align: center">
		...
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td style="width: 180px; text-align: left; height: 14px;" align="left">
					<input id="htxProduct" type="text" onchange="moveNext('htxProduct','htxCaseLabel','lbError')" 
						runat="server" enableviewstate="true" style="font-size: 7px; font-family: Verdana" size="25" /></td>
			</tr>
			<tr>
				<td style="width: 60px; text-align: right" align="right">
				...
				<td style="width: 180px; text-align: left; height: 14px;" align="left">
					<input id="htxCaseLabel" type="text" onchange="moveNext('htxCaseLabel','txQuantity','lbError')" 
						runat="server" enableviewstate="true" style="font-size: 7px; font-family: Verdana" size="40" /></td>
			</tr>
		</table>
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 70px; text-align: left">
					<asp:TextBox ID="txQuantity" runat="server" BorderColor="Black"
						BorderStyle="Solid" BorderWidth="1px" Columns="8" Font-Bold="False" Font-Size="XX-Small"
						ForeColor="Black" Wrap="False" Visible="False" AutoPostBack="True"></asp:TextBox></td>
				<td style="width: 110px; text-align: center">
					<asp:Label ID="lbQtyRemain" runat="server" Font-Bold="False" Font-Size="X-Small" ForeColor="Red"
						Style="vertical-align: middle; text-align: right" Text="- Remaining Qty - 00" Visible="False" 
						BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"></asp:Label></td>
			</tr>
		</table>
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
