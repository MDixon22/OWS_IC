Partial Public Class IC_ComboToLine
    ...
    Public Sub InitProcess()
        ...
        Me.lbComboId.Visible = True
        Me.lbComboIDVal.Visible = True
        Me.lbComboIDVal.Text = ""
    ...
    Protected Sub txData_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txData.TextChanged
        ...
        Try
            ...
            Select Case _function
                Case Is = 1 'Combo ID # was entered
                    If IsNumeric(Me.txData.Text) = False Then Throw New Exception("""ComboID# entry must be numeric. Please enter ComboID# again.""")
                    'Validate ComboID# has a status of 200 before asking for the Line #
                    If ValidateComboID(Me.txData.Text) = True Then
                        If _CheckOldestLot = "Y" Then
                            If ValidateOldestLot() = False Then Throw New Exception("""ComboID# entry is not from the Oldest Lot Available. Please enter another ComboID or see your supervisor.""")
                        End If
                    End If
                    Me.lbComboIDVal.Text = Me.txData.Text
                    Me.txData.Text = ""
    ...
    Public Function ValidateComboID(ByVal _comboid As Long) As Boolean
        ValidateComboID = False
    ...
    Protected Sub btAssignToLine_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAssignToLine.Click
        ...
        Try
            ...
            If Not sqlCmdAssignToLine Is Nothing Then
                sqlCmdAssignToLine.Parameters.AddWithValue("@nComboID", CLng(Me.lbComboIDVal.Text))
