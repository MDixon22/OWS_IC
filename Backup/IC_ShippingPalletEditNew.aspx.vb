...
Partial Public Class IC_ShippingPalletEditNew
    ...
    Private Enum ScanModes
        ...
        BinMode
        PrinterMode
        'Old way of doing the process with Case labels
        'Start Mode never used
        'OrderMode
        'ProductMode
        'CaseLabelMode
        'QuantityMode
...
#Region "Temp Table"
    ...
    Public Function WriteTempTableRecord(ByVal pallet As Long, ByVal order As Long, ByVal lineno As Integer, _
                                            ...
                                            ByVal lotno As String, ByVal caseqty As Integer, ByVal prodvariant As String, ByVal srcPallet As Long) As Boolean
                ...
                For Each drShippingPalletSave In dsShippingPalletSave.Tables(0).Rows
                    ...
                    If Not DB.MakeSQLConnection("Warehouse") Then
                        ...
                        If Not sqlCmdPalletUpdate Is Nothing Then
                            ...
                            sqlCmdPalletUpdate.Parameters.AddWithValue("@pnQuantity", CInt(Common.GetVariable("InvPalletQty", Page).ToString) - CInt(drShippingPalletSave.Item("CaseQty")))
        ...
        If Me.htxPallet.Value.Length > 0 And IsNumeric(Me.htxPallet.Value) = True Then
            ...
            Try
                ...
                If IsNumeric(Me.htxPallet.Value) = True Then
                    ...
                    If Not DB.MakeSQLConnection("Warehouse") Then
                        sqlCmdPallet = DB.NewSQLCommand3("Select GTIN,CodeDate,Ver,Qty,[Status],Lot,MfgOrd From vwIC_PalletsIC_Ship Where Pallet = " & iPallet)
                        If Not sqlCmdPallet Is Nothing Then
