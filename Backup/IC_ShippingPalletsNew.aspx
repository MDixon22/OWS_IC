	...
	<div style="text-align: left" title="IC Shipping Pallets" align="left">
			...
			<tr>
				...
				<td style="width: 170px; text-align: left; height: 14px;" align="left">
					<input id="htxPallet" type="text" onchange="moveNext('htxPallet','txQuantity','lbError')" 
						runat="server" enableviewstate="true" style="font-size: 7px; font-family: Verdana" /></td>
			</tr>
		</table>
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
		...
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 60px; text-align: right">
					<asp:Label ID="lbComplete" runat="server" Font-Bold="False" Font-Size="XX-Small" ForeColor="DarkRed"
						Style="vertical-align: middle; text-align: right" Text="x" Visible="False"></asp:Label><asp:Label
                            ID="lbPrinter" runat="server" Font-Bold="False" Font-Size="X-Small" ForeColor="DarkRed"
			...
			<tr>
				<td style="width: 240px">
					<asp:Label ID="lbError" runat="server" Font-Bold="False" Font-Size="X-Small" ForeColor="Red"
						Style="vertical-align: middle; text-align: center" Width="238px" Visible="False"></asp:Label>
				</td>
			</tr>
		</table>
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
