		...
		<tr>
			<td style="text-align: center">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="DarkRed" 
								Style="vertical-align: middle; text-align: center" Text="OW Inventory - Pallet to Void Status" EnableViewState="False" ></asp:Label>
			</td>
		</tr>
		<tr>
			<td style="text-align: center">
		...
		<tr>
			<td style="width: 90px; text-align: right">
				<asp:Label ID="lbConfirm" runat="server"
					Font-Bold="True" Font-Size="X-Small" ForeColor="DarkRed" Style="vertical-align: middle; text-align: right" Text="Confirm Void -" Visible="False"></asp:Label>
			</td>
