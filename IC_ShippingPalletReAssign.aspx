			...
			<tr>
				<td style="text-align: center; height: 19px;">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="X-Small"
						...
						Text="OW Inventory - Shipping Pallet ReAssign" EnableViewState="False" EnableTheming="False"></asp:Label></td>
			</tr>
			<tr>
				<td style="text-align: center; height: 19px;">
			...
			<tr>
				<td style="text-align: center;">
					<asp:Label ID="lbPrompt" runat="server" Font-Bold="True" Font-Size="X-Small" ForeColor="DarkRed" 
						...
						Text="Scan New Pick Order"></asp:Label></td>
			</tr>
		</table>
		<table style="width: 240px" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width: 170px; text-align: left; height: 14px;" align="left">
					<input id="htxOrder" type="text" onchange="moveNext('htxOrder','txPallet','lbError')" 
						runat="server" enableviewstate="true" style="font-size: 7px; font-family: Verdana" size="15" visible="true" /></td>
			</tr>
			<tr>
				<td style="width: 70px; text-align: right" align="right">
					<asp:Label ID="lbPallet" runat="server" Font-Bold="False" Font-Size="X-Small" ForeColor="DarkRed"
						Style="vertical-align: middle; text-align: right;" Text="Existing Pallet-" Visible="False"></asp:Label></td>
				<td style="width: 170px; text-align: left; height: 14px;" align="left">
					<asp:TextBox ID="txPallet" runat="server" BorderColor="Black"
						BorderStyle="Solid" BorderWidth="1px" Columns="12" Font-Bold="False" Font-Size="XX-Small"
			...
			<tr>
				...
				<td style="width: 170px; text-align: left; height: 14px;" align="left">
					<asp:TextBox ID="txBin" runat="server" AutoPostBack="True" BorderColor="Black"
						BorderStyle="Solid" BorderWidth="1px" Columns="12" Font-Bold="False" Font-Size="XX-Small"
						ForeColor="Black" Visible="False" Wrap="False"></asp:TextBox>
