<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IC_WorkWithShippingPallet.aspx.vb" Inherits="OWS_IC.IC_WorkWithShippingPallet" %>
		        ...
		        <tr class="row flex-fill align-content-center">
			        <td style="text-align: center">
					    <asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" Font-Size="3em" ForeColor="DarkRed" 
						    Style="vertical-align: middle; text-align: center" Text="OW Inventory - Work With Shipping Pallet" EnableViewState="False" >
					    </asp:Label>
			        </td>
		        </tr>
		        <tr class="row flex-fill align-content-center">
		        ...
		        <tr class="row flex-fill align-content-center">
			        <td style="text-align: center">
				        <asp:Label ID="lbPrompt" runat="server" Font-Bold="True" Font-Size="3em" ForeColor="DarkRed" 
						    Style="vertical-align: middle; text-align: center" Text="Scan or Enter Shipping Pallet #" >
				        </asp:Label>
			        </td>
		        </tr>
	        </table>
