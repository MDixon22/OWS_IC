...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0">
    ...
    <table class="table table-striped" style="border="0" cellpadding="0" cellspacing="0">
		<tr class="row flex-fill">
			<td class="col-1" style="text-align: center;">
					<asp:Label ID="lbPageTitle" runat="server" Font-Bold="True" ForeColor="DarkRed" Style="vertical-align: middle; text-align: center" Text="OW Inventory - Combo - Move To WIP" EnableViewState="False" ></asp:Label></td>
		</tr>
		<tr class="row flex-fill">
			<td class="col-1" style="text-align: center;">
	...
	<table class="table table-striped" style="border="0" cellpadding="0" cellspacing="0">
		<tr class="row flex-fill">
			<td class="col-1" style="vertical-align: bottom; text-align: right;">
			...
			<td class="col-1" style="vertical-align: bottom;">
				<asp:TextBox ID="txCombo" runat="server" Font-Bold="False" ForeColor="Black" Wrap="False" BorderColor="Black" AutoPostBack="True" BorderWidth="1px" Columns="12"></asp:TextBox></td>
		</tr>
		<tr class="row flex-fill">
			<td class="col-2" style="text-align: right">
			</td>
			<td class="col-2"><asp:Button ID="btNextCombo" runat="server" Text="Next Combo" Width="115px" Font-Bold="True" EnableViewState="False" /></td>
		</tr>
	</table>
